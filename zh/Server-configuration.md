...
| MarketplaceUrl | `https://raw.githubusercontent.com/HayashiUme/Empostor/main/marketplace/plugins.json` | 指向 `plugins.json` 文件的 URL。该文件定义了插件市场中可用的插件列表。 |
...
```
[Unit]
Description=Empostor Among Us 私服 - https://github.com/HayashiUme/Empostor
