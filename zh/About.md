...
[Fangkuai](https://github.com/FangkuaiYa) 随后创建了 [Fast-Impostor](https://github.com/BunchHanpiDev/Fast-Impostor)，希望从零开始重写一款增强版 Impostor 服务端。而 [HayashiUme](https://github.com/HayashiUme) 因理念不同，独立开发了 **Empostor**（[github.com/Empostor/Empostor](https://github.com/Empostor/Empostor)）。在此期间，Fangkuai 很乐意地在编写自家服务端的同时，帮助了 Empostor 的开发。

我们的初心始终如一：给社区一个**稳定、功能丰富、完全开源**的 Among Us 私服——这本就是社区应得的。

## 贡献者

| 贡献者 | 角色 |
| :--- | :--- |
| [HayashiUme (はやしうめ)](https://github.com/HayashiUme) | 项目创始人、核心开发、插件系统、文档编写 |
| [Fangkuai](https://github.com/FangkuaiYa) | 核心开发、Fast-Impostor / Next-Impostor 经验贡献 |

欢迎在 [GitHub](https://github.com/Empostor/Empostor) 上提交 Pull Request 参与贡献。

## 参考项目

Empostor 建立在以下优秀项目的基础之上：
...
| [Impostor](https://github.com/Impostor/Impostor) | 一切由此开始的开山项目。没有 Impostor，就没有后来的一切。 |

## 许可证

Empostor 基于 **GPL-3.0** 许可证发布。你可以自由使用、修改和分发，但需遵守相同条款。
