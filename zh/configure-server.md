...
**[聊天过滤](Chat-filtering.md)** 提供内置的游戏内聊天管理功能。配置屏蔽词、切换阻止/仅记录模式，以及设置刷屏速率限制。
...
**[玩家统计](Player-statistics.md)** 跟踪每个玩家的游戏数据：胜场、败场、内鬼胜场、击杀、死亡、完成任务等。可在管理面板和 `/stat` 命令中查看。

### 插件市场

**[插件市场](Plugin-marketplace.md)** 允许管理员从管理面板浏览和安装社区插件。插件在 `plugins.json` 文件中定义——详情请参阅格式参考。
